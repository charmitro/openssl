...
################################################################################
# void sha512_block_data_order_lmul1(void *c, const void *p, size_t len)
{
$code .= <<___;
.p2align 2
.globl sha512_block_data_order_zvknhb_lmul1
.type sha512_block_data_order_zvknhb_lmul1,\@function
sha512_block_data_order_zvknhb_lmul1:
    @{[vsetivli__x0_4_e64_m1_ta_ma]}
___
$code .= zvknhb_routine(1);
$code .= <<___;
.size sha512_block_data_order_zvknhb_lmul1,.-sha512_block_data_order_zvknhb_lmul1
___
}

################################################################################
# void sha512_block_data_order_lmul2(void *c, const void *p, size_t len)
{
$code .= <<___;
.p2align 2
.globl sha512_block_data_order_zvknhb_lmul2
.type sha512_block_data_order_zvknhb_lmul2,\@function
sha512_block_data_order_zvknhb_lmul2:
    @{[vsetivli__x0_4_e64_m2_ta_ma]}
___
$code .= zvknhb_routine(2);
$code .= <<___;
.size sha512_block_data_order_zvknhb_lmul2,.-sha512_block_data_order_zvknhb_lmul2
___
}
...
sub zvknhb_routine {
    ...
    if ($lmul == 1) {
        ($V0, $V10, $V11, $V12, $V13, $V14, $V15, $V16, $V17) = ("v0", "v10", "v11", "v12", "v13", "v14","v15", "v16", "v17");
        ($V26, $V27) = ("v26", "v27");
    } elsif ($lmul == 2) {
        ($V0, $V10, $V11, $V12, $V13, $V14, $V15, $V16, $V17) = ("v0", "v10", "v12", "v14", "v16", "v18","v20", "v22", "v24");
        ($V26, $V27) = ("v26", "v28");
    }
...
L_round_loop_lmul$lmul:
    ...
    @{[vmv_v_v $V26, $V16]}
    @{[vmv_v_v $V27, $V17]}
    bnez $LEN, L_round_loop_lmul$lmul
