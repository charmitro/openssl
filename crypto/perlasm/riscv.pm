...
# '@regaliases' contain the 32 aliases for the scalar registers x0...x31.
...
sub vsetivli__x0_4_e64_m2_ta_ma {
    # vsetivli x0,4,e64,m2,ta,ma
    return ".word 0xcd927057";
}
...
sub vsetivli__x0_8_e32_m2_ta_ma {
    return ".word 0xcd147057";
}
